...
class Colours {
  ...
  static const Color hint_text = Color(0xFFB6BBBC);
  ...
  static const Color bg_primary= Color(0xFF0080F9);
  ...
  static const Color selected_nav_item_color = Color(0xFF3f3f3f);
}
